...
The foremost implication of my long-term research is that the world's patents (or medical patents, in particular) should be superseded by a special class of amortizing securities coined "*Innovation-Backed Securities*" (IBS) that I have designed. Patents are almost suboptimal, but my proposed IBS can be a socially optimal alternative.
